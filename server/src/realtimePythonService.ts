...
function resolvePythonScript() {
  const candidates = [
    path.resolve(process.cwd(), 'python_service/realtime_transcription.py'),
    path.resolve(process.cwd(), 'server/python_service/realtime_transcription.py'),
    path.resolve(__dirname, '../python_service/realtime_transcription.py'),
    path.resolve(__dirname, '../../python_service/realtime_transcription.py'),
  ];
  ...
  start(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      this.process = spawn(pythonCmd, [pythonScript], {
        ...
        cwd: path.dirname(path.dirname(pythonScript)),
